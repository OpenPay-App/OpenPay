    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        {adminSections.map((section) => (
          <Link
            key={section.href}
            href={section.href}
            className="group p-6 rounded-xl border border-border bg-white hover:border-secondary/30 hover:shadow-md transition-all"
          >
      ...
      <div className="rounded-xl border border-border bg-white">
        <div className="px-6 py-4 border-b border-border">
          <h2 className="font-semibold text-text-primary">Quick Status</h2>
        </div>
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center gap-3 p-4 rounded-lg bg-bg-alt">
              ...
              <div>
                <p className="text-sm font-medium text-text-primary">Rules</p>
                <p className="text-xs text-text-muted">
            ...
            <div className="flex items-center gap-3 p-4 rounded-lg bg-bg-alt">
              ...
              <div>
                <p className="text-sm font-medium text-text-primary">Cases</p>
                <p className="text-xs text-text-muted">
