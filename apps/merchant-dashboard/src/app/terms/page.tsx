    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-gray max-w-none text-text-secondary space-y-6 text-sm leading-relaxed">
          <section>
            <h2 className="text-xl font-semibold text-text-primary mb-3">Acceptance</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-text-primary mb-3">Self-Hosted Use</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-text-primary mb-3">No Warranty</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-text-primary mb-3">Payment Processing</h2>
          ...
          <section>
            ...
            <p>For questions about these terms, open an issue on <Link href="https://github.com/openpay/openpay" className="text-secondary hover:underline">GitHub</Link>.</p>
          </section>
        </div>
      </main>
